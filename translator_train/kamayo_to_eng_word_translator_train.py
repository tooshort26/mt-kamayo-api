...
NUM_SAMPLES = 1760
MAX_VOCAB_SIZE = 1760
DATA_PATH = BASE_DIR + '/data/kamayo-to-english.txt'
WEIGHT_FILE_PATH = BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-weights.h5'
ARCHITECTURE_FILE_PATH = BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-architecture.json'
...
np.save(BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-input-word2idx.npy', input_word2idx)
np.save(BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-input-idx2word.npy', input_idx2word)
np.save(BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-target-word2idx.npy', target_word2idx)
np.save(BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-target-idx2word.npy', target_idx2word)
...
np.save(BASE_DIR + '/models/kamayo-to-eng/kamayo-to-eng-word-context.npy', context)
