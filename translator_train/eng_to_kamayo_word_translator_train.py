...
DATA_PATH = BASE_DIR + '/data/english-to-kamayo.txt'
WEIGHT_FILE_PATH = BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-weights.h5'
ARCHITECTURE_FILE_PATH = BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-architecture.json'
...
np.save(BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-input-word2idx.npy', input_word2idx)
np.save(BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-input-idx2word.npy', input_idx2word)
np.save(BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-target-word2idx.npy', target_word2idx)
np.save(BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-target-idx2word.npy', target_idx2word)
...
np.save(BASE_DIR + '/models/eng-to-kamayo/eng-to-kamayo-word-context.npy', context)
